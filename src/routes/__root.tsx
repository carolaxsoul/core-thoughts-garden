  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 font-serif text-2xl">Lost in the garden.</h2>
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="font-serif text-2xl">Something flickered.</h1>
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="rounded-full border px-5 py-2.5 text-sm font-medium hover:bg-card transition">
            Go home
          </a>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CORA — notes, stories, culture and things worth remembering." },
      { name: "description", content: "A personal digital garden and microblog. Thoughts, essays, a daily brief, and a library worth keeping." },
      { name: "author", content: "CORA" },
      { property: "og:title", content: "CORA" },
      { property: "og:description", content: "Notes, stories, culture and things worth remembering." },
